...
\begin{itemize}
  ...
  \item Computer (username \texttt{LabStudent}, password \texttt{PhaseTransition}).
...
\begin{figure}[htbp]
  ...
  \photo[width=0.62\linewidth]{sample-chamber.png}{%
    Top view of the sample chamber, with the removed metal cup cover on
    the left. A metal clip on top of the chamber holds the sample.
    The PCB connector plugs onto the metal pins at the back. The white
    cable below connects to the PID temperature controller.}
  \caption{The sample chamber with its metal cup cover removed, showing
    the sample clip, pins for connecting the PCB, and cable to the PID
...
\begin{figure}[htbp]                                                                      % change new one
  \centering
...
Figure~\ref{fig:tcguts}. The ``brain'' is an Omega CNi8DH44 unit, connected to a           % wrong
...
% =============================================================================
\section{Suggested protocol for a measurement}                                         % check pyferro/README.md
% =============================================================================
...
\clearpage
% =============================================================================
\section{Programming the temperature controller}\label{app:tempcontrol}             %remove
% =============================================================================
...
\clearpage
% =============================================================================
\section{Data taking with LabVIEW}\label{app:labview}                             %update
% =============================================================================
...
Opus 4.5 and updated by Logan Levack and Qiyun Ma.
