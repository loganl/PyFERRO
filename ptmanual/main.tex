...
%
%  Accessible (tagged, PDF/UA-2) LaTeX edition.
%  Compile with lualatex (>= TeX Live 2024).  Run twice for cross-references.
% =============================================================================

% ---- Accessibility / PDF standard -------------------------------------------
% \DocumentMetadata MUST be the very first line of the file.  It switches on
% the new LaTeX tagged-PDF engine, declares the document language, and asks for
% a PDF 2.0 file conforming to PDF/UA-2 (the accessibility standard).
\DocumentMetadata{
  tagging     = off,
  lang        = en-US,
  pdfversion  = 2.0,
...
\begin{figure}[htbp]                                                                       %change image and context
  \centering
